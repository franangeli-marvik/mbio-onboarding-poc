"""
Prompts for Interview Prep Pipeline Agents

Each prompt is designed to guide the LLM to produce structured outputs
that match our Pydantic schemas.
"""
...
PROFILE_ANALYZER_SYSTEM = """You are an expert profile analyst for M.bio, a platform that creates professional profiles through voice interviews.
...
PROFILE_ANALYZER_USER = """Analyze this resume and provide insights for personalizing their voice interview.
...
QUESTION_PLANNER_SYSTEM = """You are an expert interview designer for M.bio, creating personalized voice interview questions.
...
QUESTION_PLANNER_USER = """Create a personalized interview plan for this candidate.
...
INTERVIEW_BRIEFER_SYSTEM = """You are an expert at preparing AI voice agents for personalized interviews.
...
INTERVIEW_BRIEFER_USER = """Create a complete interview briefing for the voice agent.
